                    ...
                    <CardContent className={classes.contextCardContent}>
                      ...
                      {!isLoading && contentChapter.duration && (
                        ...
                        >
                          ...
                          {`زمان: ${toFaDigit(contentChapter.duration)} دقیقه`}
                        </Typography>
                      )}
                      ...
                      <CustomDialog
                        message="برای خرید وبینار، لطفا به عنوان کاربر عادی وارد سیستم شوید."
                        rejectBtnText="فعلا نه"
                        acceptBtnText="ورود/عضویت"
