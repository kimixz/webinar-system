...
function LecturerWebinar() {
  ...
  useEffect(() => {
    api
      .getLecturerWebinars({ params: { lecturerId: id } })
      .then(res => {
      ...
      <Grid item xs={12}>
        <TableContainer component={Paper}>
          <Table className={classes.table} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell className={classes.indexColumn}>ردیف</TableCell>
                <TableCell>عکس</TableCell>
                <TableCell>نام وبینار</TableCell>
                <TableCell>سطح وبینار</TableCell>
                <TableCell>زمان برگزاری</TableCell>
            ...
            <TableBody>
              {webinarList.map((webinar, index) => (
                <TableRow key={webinar.webinarId}>
                  ...
                  >
                    {webinar.isAccepted ? 'تایید شده' : 'تایید نشده'}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
...
export default LecturerWebinar
